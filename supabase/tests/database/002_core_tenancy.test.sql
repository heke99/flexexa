...
insert into public.metering_points(tenant_id,site_id,metering_point_identifier) values
...
insert into public.asset_capabilities(tenant_id,asset_id,capability_key) values
...
-- These run as database owner: the constraints must protect integrity even without RLS.
...
select throws_ok($$insert into public.metering_points(tenant_id,site_id,metering_point_identifier) values('c1000000-0000-4000-8000-000000000001','f1000000-0000-4000-8000-000000000002','wrong')$$,'23503',null,'meter cannot point at another tenant site');
...
select throws_ok($$insert into public.asset_capabilities(tenant_id,asset_id,capability_key) values('c1000000-0000-4000-8000-000000000001','a2000000-0000-4000-8000-000000000002','read_energy')$$,'23503',null,'capability cannot point at another tenant asset');
