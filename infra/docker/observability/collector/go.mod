...
module github.com/heke99/flexexa/infra/docker/observability/collector

go 1.26.0

require (
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/clickhouseexporter v0.160.0
