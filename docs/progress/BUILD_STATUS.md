...
| OpenTelemetry Collector | Isolated runtime candidate: real SDK forwarding, bounded retry, loopback listeners, health and Prometheus self-metrics. Final exact-image CI required before merge. No durable trace store or AWS deployment. |
