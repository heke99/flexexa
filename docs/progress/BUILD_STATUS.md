...
| Valkey runtime | PR #26 candidate runtime job `102825973606` passed health/auth, nine negative cases, 24 advisory lease races, expiry/stale-owner safety, restart cache loss and shutdown. OS scan: 23 packages, no HIGH/CRITICAL findings; source-built server advisory review is separate. Final tracked CI evidence is in the PR. No app integration or AWS deployment claimed. |
