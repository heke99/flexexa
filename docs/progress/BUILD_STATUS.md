...
| Migration history synchronization | Permanent source/base history gate and fresh development snapshot checker; 15 pinned migrations, four exact reviewed historical formatting exceptions. See [verification procedure](../quality/migration-synchronization.md). |
