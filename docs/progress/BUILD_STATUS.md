...
| ClickHouse runtime | Isolated telemetry schema/runtime candidate; final real SQL/isolation/retention/restart and image evidence required in its PR. No production pipeline claimed. |
