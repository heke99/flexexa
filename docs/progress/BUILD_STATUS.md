...
| Identity OpenTelemetry | SDK/OTLP trace candidate with bounded export, server/client parentage and privacy checks. Enabled real Auth/container export verification is required in CI. Collector deployment, metrics and alerting remain pending. |
