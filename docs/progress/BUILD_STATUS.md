...
| Provider account transactions | PR #10 adds guarded pending registration and local revocation, canonical contracts and receipt/audit/outbox atomicity. Isolated proposal and pinned application passed; exact migration `20260909155618` is in development. Final tracked-only release gate and merge are recorded in PR #10. |
